...
import com.mta.musictube.extractor.genre.GenreInfoItem;
import com.mta.musictube.extractor.genre.GenreInfoItemsCollector;
...
public class MyGenreExtractor extends GenreExtractor {
    ...
    @Override
    public ListExtractor.InfoItemsPage<GenreInfoItem> getPage(String pageUrl) throws IOException, ExtractionException {
        return null;
    }
