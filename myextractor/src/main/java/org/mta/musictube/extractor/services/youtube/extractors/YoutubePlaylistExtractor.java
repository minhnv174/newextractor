...
import org.mta.musictube.extractor.services.youtube.linkHandler.YoutubeParsingHelper;
...
public class YoutubePlaylistExtractor extends PlaylistExtractor {
    ...
    public ListExtractor.InfoItemsPage<StreamInfoItem> getPage(final String pageUrl) throws IOException, ExtractionException {
        ...
        return new ListExtractor.InfoItemsPage<>(collector, getNextPageUrlFromAjax(pageJson, pageUrl));
    }
