...
import org.video.imusictube.extractor.utils.Parser.RegexException;
...
import static org.video.imusictube.extractor.utils.Utils.replaceHttpWithHttps;
...
public class SoundcloudParsingHelper {
    ...
    public static String resolveUrlWithEmbedPlayer(String apiUrl) throws IOException, ReCaptchaException, ParsingException {
        ...
        String response = MusicTube.getDownloader().download("https://w.soundcloud.com/player/?url="
     ...
     *
     * @return the next stream url, empty if don't have
     */
    public static String getUsersFromApi(ChannelInfoItemsCollector collector, String apiUrl) throws IOException, ReCaptchaException, ParsingException {
        String response = MusicTube.getDownloader().download(apiUrl);
    ...
    /**
     * Fetch the stream from the given api and commit each of them to the collector.
     * <p>
