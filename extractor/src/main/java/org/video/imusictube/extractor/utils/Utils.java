...
public class Utils {
    ...
    public  static String buildUrlArtist(String version, String alphabet) {
        return Utils.combinePaths(getHostMyData(), String.format(ExtractorConstant.ARTIST_BY_VERSION, version), alphabet, ExtractorConstant.ARTISTS);
    }
    public  static String buildUrlListByArtist(String version, String alphabet, String artist) {
        return Utils.combinePaths(getHostMyData(), String.format(ExtractorConstant.ARTIST_BY_VERSION, version), alphabet, String.format(ExtractorConstant.JSON_FILE_FORMAT, artist));
    }
