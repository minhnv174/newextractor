...
import org.video.imusictube.extractor.Extractor;
import org.video.imusictube.extractor.MediaFormat;
...
public abstract class StreamExtractor extends Extractor {
     ...
     * dd.mm.yyyy, however it MusicTube will not crash if its not.
     ...
     * so be sure to implement that one before you return a value here, otherwise MusicTube will crash if one selects
     * this url.
     ...
     * for HLS stream. Prove me if I am wrong. Please open an
     ...
     * @return a list of audio only stream in the format of AudioStream
     * @throws IOException
    ...
    /**
     * This should return a list of available
     * Be aware this is the list of video stream which do contain an audio stream.
     * You can also return null or an empty list, however be aware that if you don't return anything
     * in getAudioStreams(), getVideoOnlyStreams() and getDashMpdUrl() either the Collector will handle this as
     * a failed extraction procedure.
     * @return a list of combined video and stream in the format of AudioStream
     * @throws IOException
     * @throws ExtractionException
     */
    ...
    /**
     * This should return a list of available
     * Be aware this is the list of video stream which do NOT contain an audio stream.
     * You can also return null or an empty list, however be aware that if you don't return anything
     * in getAudioStreams(), getVideoStreams() and getDashMpdUrl() either the Collector will handle this as
     * a failed extraction procedure.
     * @return a list of video and stream in the format of AudioStream
     * @throws IOException
     * @throws ExtractionException
     */
    ...
    /**
     * should return the url of the next stream. MusicTube will automatically play
    ...
    /**
     * Should return a list of stream related to the current handled. Many services show suggested
     * stream. If you don't like suggested stream you should implement them anyway since they can
     ...
     * @return a list of InfoItems showing the related videos/stream
     * @throws IOException
     * @throws ExtractionException
     */
