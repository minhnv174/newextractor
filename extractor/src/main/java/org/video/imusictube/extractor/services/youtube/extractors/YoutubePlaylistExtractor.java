...
import org.video.imusictube.extractor.services.youtube.linkHandler.YoutubeParsingHelper;
    ...
    private String getNextPageUrlFrom(Document d) throws ParsingException {
        try {
            ...
            if (button != null) {
                ...
                // Sometimes playlists are simply so small, they don't have a more stream/videos
                return "";
            }
        } catch (Exception e) {
            throw new ParsingException("could not get next stream' url", e);
        }
    }
