...
import org.video.imusictube.extractor.stream.AudioStream;
import org.video.imusictube.extractor.stream.Stream;
import org.video.imusictube.extractor.stream.StreamInfo;
import org.video.imusictube.extractor.stream.VideoStream;
...
public class DashMpdParser {
     ...
     * <p>
     * It has video, video only and audio stream and will only add to the list if it don't
     ...
     *
     * @param streamInfo where the parsed stream will be added
     */
        ...
        try {
            ...
            for (int i = 0; i < representationList.getLength(); i++) {
                ...
                try {
                    ...
                    // Instead of putting those stream into the list of regular stream urls wie put them in a
