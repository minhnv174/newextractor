...
import org.video.imusictube.extractor.DownloadRequest;
import org.video.imusictube.extractor.DownloadResponse;
...
import org.video.imusictube.extractor.comment.CommentsInfoItem;
import org.video.imusictube.extractor.comment.CommentsInfoItemExtractor;
import org.video.imusictube.extractor.comment.CommentsInfoItemsCollector;
...
import org.video.imusictube.extractor.utils.JsonUtils;
...
public class YoutubeCommentsExtractor extends CommentsExtractor {
    ...
    private String makeAjaxRequest(String siteUrl) throws IOException, ReCaptchaException {
        ...
        return MusicTube.getDownloader().get(siteUrl, request).getResponseBody();
    }
