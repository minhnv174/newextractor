...
public abstract class StreamingService {
     ...
     * of MusicTube should handle a certain URL.
     */
     ...
     * @param id the number of the service to identify him within the MusicTube frontend
     * @param name the name of the service
    ...
    /**
     * Must return a new instance of an implementation of LinkHandlerFactory for stream.
     * @return an instance of a LinkHandlerFactory for stream
     */
    ...
    public SearchExtractor getSearchExtractor(SearchQueryHandler queryHandler) {
        return getSearchExtractor(queryHandler, MusicTube.getPreferredLocalization());
    }

    public SuggestionExtractor getSuggestionExtractor() {
        return getSuggestionExtractor(MusicTube.getPreferredLocalization());
    }
    ...
    public ChannelExtractor getChannelExtractor(String url) throws ExtractionException {
        return getChannelExtractor(getChannelLHFactory().fromUrl(url), MusicTube.getPreferredLocalization());
    }

    public GenreExtractor getGenreExtractor(String url) throws ExtractionException {
        return getGenreExtractor(getGenreLHFactory().fromUrl(url), MusicTube.getPreferredLocalization());
    }

    public ArtistExtractor getArtistExtractor(String url) throws ExtractionException {
        return getArtistExtractor(getArtistLHFactory().fromUrl(url), MusicTube.getPreferredLocalization());
    }

    public AlphabetExtractor getAlphabetExtractor(String url) throws ExtractionException {
        return getAlphabetExtractor(getAlphabetLHFactory().fromUrl(url), MusicTube.getPreferredLocalization());
    }

    public SuggestExtractor getSuggestExtractor(String url) throws ExtractionException {
        return getSuggestExtractor(getSuggestLHFactory().fromUrl(url), MusicTube.getPreferredLocalization());
    }

    public ListDataExtractor getListDataExtractor(String url) throws ExtractionException {
        return getListDataExtractor(getListDataLHFactory().fromUrl(url), MusicTube.getPreferredLocalization());
    }

    public PlaylistExtractor getPlaylistExtractor(String url) throws ExtractionException {
        return getPlaylistExtractor(getPlaylistLHFactory().fromUrl(url), MusicTube.getPreferredLocalization());
    }

    public StreamExtractor getStreamExtractor(String url) throws ExtractionException {
        return getStreamExtractor(getStreamLHFactory().fromUrl(url), MusicTube.getPreferredLocalization());
    }
    ...
    public CommentsExtractor getCommentsExtractor(String url) throws ExtractionException {
        ...
        return getCommentsExtractor(llhf.fromUrl(url), MusicTube.getPreferredLocalization());
    }
