...
import org.video.imusictube.extractor.exception.ContentNotAvailableException;
...
import org.video.imusictube.extractor.services.youtube.ItagItem;
import org.video.imusictube.extractor.stream.*;
...
public class YoutubeStreamExtractor extends StreamExtractor {
    ...
    public List<AudioStream> getAudioStreams() throws IOException, ExtractionException {
        ...
        if(isUseYoutubeApi) {
            ...
            try {
                ...
                throw new ParsingException("Could not get audio stream", e);
            }
            return audioStreams;
        }
    }
    ...
    public List<VideoStream> getVideoStreams() throws IOException, ExtractionException {
        ...
        if(isUseYoutubeApi) {
            ...
            try {
                ...
                throw new ParsingException("Could not get video stream", e);
            }
            return videoStreams;
        }
    }
    ...
    public List<VideoStream> getVideoOnlyStreams() throws ExtractionException {
        ...
        try {
            ...
            throw new ParsingException("Could not get video only stream", e);
        }
    ...
    private EmbeddedInfo getEmbeddedInfo() throws ParsingException, ReCaptchaException {
        try {
            final Downloader downloader = MusicTube.getDownloader();
    ...
    private String loadDecryptionCode(String playerUrl) throws DecryptException {
        try {
            Downloader downloader = MusicTube.getDownloader();
    ...
    private List<SubtitlesInfo> getAvailableSubtitlesInfo() throws SubtitlesException {
        ...
        try {
            playerConfig = getPlayerConfig(getPageHtml(MusicTube.getDownloader()));
    ...
    private Map<String, ItagItem> getItags(String encodedUrlMapKey, ItagItem.ItagType itagTypeWanted) throws ParsingException {
        ...
        for (String url_data_str : encodedUrlMap.split(",")) {
            try {
                // This loop iterates through multiple stream, therefore tags
